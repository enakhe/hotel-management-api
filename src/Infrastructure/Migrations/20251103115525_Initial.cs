        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxReports = table.Column<int>(type: "int", nullable: false),
                    MaxIntegrations = table.Column<int>(type: "int", nullable: false),
                    CustomLimits = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValue: "Available"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LimitsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Plans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Plans_Limits_LimitsId",
                        column: x => x.LimitsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.ApplicationRoleId, x.PermissionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValue: "Confirmed"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastValidated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ValidationCount = table.Column<int>(type: "int", nullable: false),
                    MaxValidations = table.Column<int>(type: "int", nullable: true),
                    HardwareId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DomainRestrictions = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LicenseValidation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LicenseValidation_Licenses_LicenseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "WAT"),
                    CurrencyCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, defaultValue: "NGN"),
                    LanguageCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, defaultValue: "en"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    PlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LicenseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    LimitsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tenants_Limits_LimitsId",
                        column: x => x.LimitsId,
                        principalTable: "Limits",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TenantId_BranchId_IsActive",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenseValidation_LicenseId",
                table: "LicenseValidation",
                column: "LicenseId");

            migrationBuilder.CreateIndex(
                name: "IX_Limits_IsActive",
                table: "Limits",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Limits_IsDefault",
                table: "Limits",
                column: "IsDefault");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanModules_DisplayOrder",
                table: "PlanModules",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_PlanModules_IsRequired",
                table: "PlanModules",
                column: "IsRequired");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_TenantId_RoomNumber",
                table: "Rooms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuperAdminAuditLogs_SuperAdminId",
                table: "SuperAdminAuditLogs",
                column: "SuperAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_SuperAdminAuditLogs_SuperAdminId_Timestamp",
                table: "SuperAdminAuditLogs",
                columns: new[] { "SuperAdminId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_SuperAdminAuditLogs_TargetType",
                table: "SuperAdminAuditLogs",
                column: "TargetType");

            migrationBuilder.CreateIndex(
                name: "IX_SuperAdminAuditLogs_TenantId",
                table: "SuperAdminAuditLogs",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SuperAdminAuditLogs_TenantId_Timestamp",
                table: "SuperAdminAuditLogs",
                columns: new[] { "TenantId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_SuperAdminAuditLogs_Timestamp",
                table: "SuperAdminAuditLogs",
                column: "Timestamp");
